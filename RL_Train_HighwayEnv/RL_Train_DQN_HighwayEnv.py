"""
*******************************************************************************
                            [RL_Train_DQN_HighwayEnv]
*******************************************************************************
File: RL_Train_DQN_HighwayEnv.py
...
Training RL DQN Agent on Highway-Env Environment: Tensorboard Log Files
Disclaimer:
------------
...
TIMESTEPS = 2e4
for i in range(1, 3):
    model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False, tb_log_name="DQNlogs",  progress_bar=True)
    # Save the agent
