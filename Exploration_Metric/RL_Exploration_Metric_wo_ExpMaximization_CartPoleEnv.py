"""
*******************************************************************************
                            [RL_Exploration_Metric_wo_ExpMaximization_CartPoleEnv]
*******************************************************************************
File: RL_Exploration_Metric_wo_ExpMaximization_HighwayEnv.py
...
def plot_exploration_metrics_result(Exploration_Metric1_list, Exploration_Metric2_list, taken_actions_list, visited_segments_list, epsilon_values_list, epsilon_crossed50Percent):
    ...
    # Set x-axis limits to start from zero
    plt.xlim(0, total_episode_count + 50)
    ...
    plt.suptitle('Exploration Patterns: DQN Agent Exploration Metrics Over Episodes (w/o Maximization)')
    ...
    plt.text(0., -0.12, f'{max_unique_actions} Unique Taken Actions in {max_visited_segments} Visited Segments', transform=plt.gca().transAxes, color='black')
